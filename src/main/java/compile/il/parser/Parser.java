...
import compile.il.ast.AExp;
import compile.il.ast.Addition;
import compile.il.ast.Assignment;
import compile.il.ast.BExp;
import compile.il.ast.CompareEqual;
import compile.il.ast.CompareLessOrEqual;
import compile.il.ast.Conjunction;
import compile.il.ast.IfThenElse;
import compile.il.ast.Multiplication;
import compile.il.ast.Negation;
import compile.il.ast.Numeral;
import compile.il.ast.Sequence;
import compile.il.ast.Stmt;
import compile.il.ast.Subtraction;
import compile.il.ast.TruthValue;
import compile.il.ast.Variable;
import compile.il.ast.WhileDo;
 ...
 *
 * @version Wed Oct 05 21:21:22 UYST 2016
 */
        ...
        switch (CUP$Parser$act_num) {
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
            case 18: // bexp ::= LEFT_PARENTHESIS bexp RIGHT_PARENTHESIS
            {
                ...
                Object $1 = ((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)).value;
                ...
                Object $3 = ((Symbol) CUP$Parser$stack.peek()).value;
                RESULT = $2;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
            case 17: // bexp ::= bexp DOUBLE_AMPERSAND bexp
            {
                ...
                int $2left = ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).left;
                int $2right = ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).right;
                Object $2 = ((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).value;
                int $3left = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).left;
                int $3right = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).right;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
            case 16: // bexp ::= EXCLAMATION_MARK bexp
            {
                ...
                int $1left = ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).left;
                int $1right = ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).right;
                Object $1 = ((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).value;
                int $2left = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).left;
                int $2right = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).right;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
            case 13: // bexp ::= FALSE
            {
                ...
                Object $1 = ((Symbol) CUP$Parser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
            case 5: // stmt ::= IF bexp THEN stmt ELSE stmt
            {
                ...
                Object $1 = ((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 5)).value;
                ...
                Object $3 = ((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 3)).value;
                ...
                Object $5 = ((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
            case 4: // stmt ::= WHILE bexp DO stmt
            {
                ...
                Object $1 = ((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 3)).value;
                ...
                Object $3 = ((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
            case 2: // stmt ::= SKIP SEMICOLON
            {
                ...
                int $2left = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).left;
                int $2right = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).right;
                Object $2 = ((Symbol) CUP$Parser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
            case 1: // stmt ::= ID EQUALS_SIGN aexp SEMICOLON
            {
                ...
                int $2left = ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)).left;
                int $2right = ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)).right;
                Object $2 = ((Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)).value;
                int $3left = ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).left;
                int $3right = ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).right;
                AExp $3 = (AExp) ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)).value;
                int $4left = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).left;
                int $4right = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).right;
                Object $4 = ((Symbol) CUP$Parser$stack.peek()).value;
